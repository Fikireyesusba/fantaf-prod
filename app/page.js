...
const SOCIAL_LINKS = [
  ...
  {
    name: "Facebook",
    url: "https://www.facebook.com/fikireyesus_bancha",
    color: "#1877F2",
    icon: (
      <svg viewBox="0 0 24 24" width="22" height="22" fill="currentColor">
  ...
  {
    name: "Gmail",
    url: "mailto:fikireyesusb@gmail.com",
    color: "#EA4335",
    icon: (
      <svg viewBox="0 0 24 24" width="22" height="22" fill="currentColor">
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(300px,1fr))", gap: "3rem", alignItems: "start" }}>
            ...
            <div style={{ background: "rgba(255,255,255,0.06)", border: "1px solid rgba(255,255,255,0.12)", borderRadius: 10, padding: "2rem", textAlign: "center" }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
                ...
                <a href="https://wa.me/48780517696" target="_blank" rel="noopener noreferrer"
